...
class coolsms
{
	...
	public function curlProcess()
	{
		...
		if(isset($this->result->code)) $this->error = 'Code : ' . $this->result->code . ' Message : ' . $this->result->message;
	...
	private function addInfos($options)
	{
		...
		if(isset($options->sdk_version)) $options->sdk_version = sprintf("PHP SDK %s", $this->sdk_version);
