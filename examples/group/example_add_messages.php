 ...
 * #example_send
 *
 * This sample code demonstrate how to add messages into group through CoolSMS Rest API PHP v1.0
 * for more info, visit
 * www.coolsms.co.kr
 */
...
// $options->image_id = 'desert.jpg'		// image_id. type must be set as 'MMS'
